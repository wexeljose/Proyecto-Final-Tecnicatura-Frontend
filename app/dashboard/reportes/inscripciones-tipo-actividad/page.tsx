...
import { getReporteInscripcionesPorTipo } from "../../../services/inscripcion";
import { obtenerTiposDeActividad } from "../../../services/tipoDeActividad";
import { InscripcionActividadReporte } from "../../../../types/inscripcion";
import { TipoActividad } from "../../../../types/tipoDeActividad";
import * as XLSX from "xlsx";

export default function ReporteInscripcionesPorTipo() {
  // Estados de filtros
  ...
  async function handleBuscar() {
    ...
    if (tiposSeleccionados.length === 0) {
      toast.error("Debes seleccionar al menos un tipo de actividad ⚠️");
      return;
    }
    ...
    try {
      console.log("🔍 Buscando con filtros:", {
        ...
        fechaHasta,
        cancelada,
        tiposActividad: tiposSeleccionados,
      });

      const resultados = await getReporteInscripcionesPorTipo({
        fechaDesde,
        fechaHasta,
        cancelada,
        tiposActividad: tiposSeleccionados,
  ...
  function handleExportarExcel() {
    ...
    try {
      ...
      const nombreArchivo = `Reporte_Inscripciones_PorTipo_${fechaActual}.xlsx`;
  ...
  return (
    <div className="p-6">
      <h1 className="text-xl font-bold text-gray-900 mb-4">
        Reporte de Inscripciones / Cancelaciones por Tipo de Actividad
      </h1>
      ...
      <div className="bg-white border border-gray-200 rounded shadow p-4 mb-4">
              ...
              {tipos.length === 0 ? (
                ...
                tipos.map((tipo) => (
                  ...
                  >
                    ...
                    />
                    <span className="text-sm text-gray-900">{tipo.nombre}</span>
                  </label>
                ))
              )}
            </div>
        ...
        <div className="mt-3">
          <button
            ...
            disabled={loading || !fechaDesde || !fechaHasta || tiposSeleccionados.length === 0}
